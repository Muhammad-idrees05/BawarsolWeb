    ...
    <footer className="bg-[#050505] text-slate-400 pt-16 pb-12 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-slate-400 text-sm max-w-md leading-relaxed">
              BawarSol is a premier AI engineering and software development company building intelligent, scalable, and production-ready technology solutions for ambitious enterprises worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                { name: 'Portfolio Gateway', path: '/portfolio' },
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          <div>
            © 2026 <span className="text-white font-semibold">BawarSol</span>. All rights reserved. Engineering Intelligent Solutions.
          </div>
