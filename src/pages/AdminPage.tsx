...
export const AdminPage: React.FC<AdminPageProps> = ({ onNavigate }) => {
  ...
  const [emailInput, setEmailInput] = useState('admin@bawarsol.ai');
  const [passwordInput, setPasswordInput] = useState('admin_password_123');
      ...
      <div className="min-h-screen bg-[#050505] text-[#F0F0F0] flex items-center justify-center p-4">
        <div className="w-full max-w-md p-8 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 shadow-2xl space-y-6">
          ...
          <p className="text-[11px] text-center text-slate-400">
            Default credentials: <code className="text-[#00F0FF]">admin@bawarsol.ai</code> / <code className="text-[#00F0FF]">admin_password_123</code>
          </p>
        </div>
      </div>
    );
